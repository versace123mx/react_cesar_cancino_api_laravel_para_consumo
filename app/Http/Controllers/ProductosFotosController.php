...
class ProductosFotosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($_FILES["imagen"]["type"]=='image/jpeg' or $_FILES["imagen"]["type"]=='image/png')
        {
            ...
            // VariablesGlobales::find(10)->valor apunta a una base de datos donde tiene valores generales variables_globales
            //copy($_FILES["imagen"]["tmp_name"], VariablesGlobales::find(10)->valor."uploads/productos/".$archivo);
            copy($_FILES["imagen"]["tmp_name"], public_path("uploads/productos/").$archivo);
        }else
        {
            $array=
		        	array
    ...
    public function destroy($id)
    {
        ...
        unlink(public_path("uploads/productos/").$datos->nombre);
        //unlink();
